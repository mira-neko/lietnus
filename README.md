...
Склоняемые названия и имена из других языков адаптируются: если последняя буква — гласная, она заменяется, иначе просто добавляется соответствующее окончание, дальше действуют обычные правила лиитнийского.
